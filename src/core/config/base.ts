...
export const REPORTS_OUT_DIR = ".reports";

export const base: WebdriverIO.Config = {
  //
  // ====================
  ...
  reporters: [
    "spec",
    ["junit", { outputDir: path.join(REPORTS_OUT_DIR, "junit") }],
    [
      "allure",
      {
        ...
        outputDir: path.join(REPORTS_OUT_DIR, "allure")
      }
    ]
  ],
