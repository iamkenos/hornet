Feature: I. Mouse Actions - Move and scroll
  ...
  Scenario: S01: Show coordinates
    When I move to the "#move-to" element
    Then I expect the "#move-to-result" element text to be "X: 879 | Y: 2078"
      But I move to the "#move-to-result" element
      And I move to the "#move-to" element with an offset of 5,10
    Then I expect the "#move-to-result" element text to not be "X: 879 | Y: 2078"
  ...
  Scenario: S02: Show element location
    ...
    Then I expect the "#scroll-to-result" element to be displayed within the viewport
      And I expect the "#scroll-to-result" element text to be "Left: 987.75 | Top: 953.265625"
