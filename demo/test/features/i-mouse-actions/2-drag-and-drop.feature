Feature: I. Mouse Actions - Drag and drop
  ...
  Scenario: S01: Drag an element to another element
    When I drag the "#drag-drop-source" element to the "#drag-drop-target" element
      And I expect the "#drag-drop-source" element location at x axis to be 963.75
      And I expect the "#drag-drop-source" element location at y axis to be 1354.265625
      But I drag the "#drag-drop-source" element to the "#move-to-result" element
    Then I expect the "#drag-drop-source" element location at x axis to not be 963.75
      And I expect the "#drag-drop-source" element location at y axis to not be 1354.265625
