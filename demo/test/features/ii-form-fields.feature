Feature: II. Form Fields
  ...
  Background:
    Given I open the url "/"
      ...
      And I expect the section header "II. Form Fields" to be existing
  ...
  Scenario: Change textarea value
    ...
    Then I expect the "#fmTextarea" field value to contain:
      ...
      on [fmTextarea]...
      """
    Then I expect the "#fmTextarea" field value to be:
      """
      This
    ...
    Then I expect the "#fmTextarea" field value to not contain:
      ...
      on [fmTextarea]...
      """
      And I expect the "#fmTextarea" field value to not be:
      """
      This
