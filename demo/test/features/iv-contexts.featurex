Feature: IV. Contexts
  ...
  Background:
    Given I open the "Demo" page's url
      ...
      And I expect the section header "IV. Contexts" to be existing
  ...
  Scenario: Navigate pages in the same window
    ...
    Then I expect to be on the "iframe" page
      And I expect the "Level 1 List Items" element count to not be 0
      And I expect the "Level 1 List Items" element count to be more than 4
      And I expect the "Level 1 List Items" element count to be less than 6
      And I expect the "Level 1 List Items" element count to not be more than 6
      And I expect the "Level 1 List Items" element count to not be less than 4
  ...
  Scenario: Open link in a new window and switch context
    ...
    Then I expect the window count to be more than 1
    ...
    Then I expect the page title to not contain "Demo Page"
      ...
      And I expect the page title to not match the "Demo" page's title
  ...
  Scenario: Switch context over to an iframe
    ...
    Then I expect the "iFrame" page's "Level 1 List Items" element to not be existing
