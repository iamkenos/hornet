Feature: I. Mouse Actions
  ...
  Background:
    Given I open the "Demo" page's url
      ...
      And I expect the section header "I. Mouse Actions" to be existing

  Scenario: Create new element on button click
    When I click the "#createElemBtn" button
    Then I expect the "#createElemDest" element to be existing
      But I click the "#createElemBtn" button again
    Then I expect the "#createElemDest" element to not be existing
  ...
  Scenario: Change element text on button right click
    ...
    Then I expect the "#changeTxtDest" link to open on a new window
      And I expect the "#changeTxtDest" link to point to a path "/internal/path"
      And I expect the "#changeTxtBtnLink2" element to open on the same frame
      And I expect the "#changeTxtBtnLink2" element to point to a section "#content1"
      And I expect the "#changeTxtBtnLink3" element to open on the parent frame
      And I expect the "#changeTxtBtnLink3" element to point to a mail "someone@example.com"
      And I expect the "#changeTxtBtnLink4" element to open on the top frame
      And I expect the "#changeTxtBtnLink4" element to point to a tel "+4733378901"
      And I expect the "#changeTxtBtnLink5" element to open on a named frame "framename"
      And I expect the "#changeTxtBtnLink5" element to point to an absolute url "https://otherdomain.com/external/path"
      And I expect the "#changeTxtBtnLink5" element to not open without a target
      And I expect the "#changeTxtBtnLink6" element to open without a target
      And I expect the "#changeTxtBtnLink6" element to point to "javascript:alert('Hello World!');"
      And I expect the "#changeTxtBtnLink6" element to not point to the "Demo" page
  ...
  Scenario: Change element value on button middle click
    ...
    Then I expect the "#changeValDest" field value to contain "[changeValBtn]"
      ...
      And I expect the "#changeValDest" field "class" attribute to be existing
    ...
    Then I expect the "#changeValDest" field value to not contain "[changeValBtn]"
      ...
      And I expect the "#changeValDest" field "class" attribute to not be existing
  ...
  Scenario: Change element inner html on button double click
    ...
    Then I expect the "#changeInnerHtmlBtn" element to not be enabled
      ...
      """
      And I expect the "#changeInnerHtmlDest" element text to be:
      """
      Double click
      ...
      [changeInnerHtmlBtn]...
      """
      And I expect the "#changeInnerHtmlDest" field "border-color" css property to be existing
    ...
    Then I expect the "#changeInnerHtmlBtn" element to be enabled
      ...
      to revert the changes of
      """
      And I expect the "#changeInnerHtmlDest" element text to not be:
      """
      Double click
      ...
      [changeInnerHtmlBtn]...
      """
      And I expect the "#changeInnerHtmlDest" field "lipsum" css property to not be existing
  ...
  Scenario: Scroll to be existing element
    ...
    Then I expect the "#scrollToElementBoxDest" element text to be "Left: 532.5 | Top: 1184.1875"
  ...
  Scenario: Scroll to a part of the window
    ...
    Then I expect the "#scrollToElementBoxDest" element to be displayed within the viewport
      And I expect the "#scrollToElementBoxDest" element text to be "Left: 532.5 | Top: 1184.1875"
