...
((global as any).browser as typeof browser).clearLocalStorage = jest.fn();
((global as any).browser as typeof browser).clearSessionStorage = jest.fn();
((global as any).browser as typeof browser).closeWindow = jest.fn();
((global as any).browser as typeof browser).conditions = jest.fn();
((global as any).browser as typeof browser).deleteCookies = jest.fn();
...
((global as any).browser as typeof browser).getWindowSize = jest.fn();
((global as any).browser as typeof browser).getWindowHandles = jest.fn();
((global as any).browser as typeof browser).performActions = jest.fn();
((global as any).browser as typeof browser).keys = jest.fn();
((global as any).browser as typeof browser).pause = jest.fn();
((global as any).browser as typeof browser).releaseActions = jest.fn();
((global as any).browser as typeof browser).restoreWindowSize = jest.fn();
((global as any).browser as typeof browser).setWindowSize = jest.fn();
((global as any).browser as typeof browser).setCookies = jest.fn();
((global as any).browser as typeof browser).storeWindowSize = jest.fn();
((global as any).browser as typeof browser).switchToWindow = jest.fn();
