...
(global.browser as typeof browser).getAlertText = jest.fn();
(global.browser as typeof browser).getCookies = jest.fn();
(global.browser as typeof browser).getTitle = jest.fn();
(global.browser as typeof browser).getUrl = jest.fn();
(global.browser as typeof browser).getWindowHandles = jest.fn();
